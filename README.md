...
The idea in one sentence: **you own the plan and the taste, Claude builds, and nothing counts as
done until you have both looked at a screenshot of it working.**
...
| `02-THE-LOOP.md` | The agentic loop: plan, build, turn, screenshot, critique, fix, commit |
...
| `skills/turn-critique/` | The most important skill: verify UI work with real turns and read the pictures |
...
- **A turn** is one real use of your app, the way a user would do it, ending in a screenshot.
